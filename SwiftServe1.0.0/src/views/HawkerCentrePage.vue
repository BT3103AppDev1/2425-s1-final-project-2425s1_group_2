    ...
    return {
      ...
      stalls: [
        ...
        },
        {
          ...
          category: 'Indian',
          addOns: [
            { name: 'Raita', price: 0.5 },
            { name: 'Boiled Egg', price: 1.0 }
          ],
          halal: true,
          vegetarian: false
        },
      ...
      items: [
        ...
        },
        {
          ...
          price: 4.8,
          category: 'Chinese',
          image: 'images/roasted-chicken-rice.jpg',
          stallId: 1
        },
        {
          id: 3,
          ...
          price: 5.0,
          category: 'Chinese',
          image: 'images/char-siew-rice.jpg',
          stallId: 1
        },
        {
          id: 4,
        ...
        },
        {
          ...
          price: 3.0,
          category: 'Chinese',
          image: 'images/veg-beehoon.jpg',
          stallId: 4
        },
        {
          id: 8,
          name: 'Vegetarian Char Kway Teow',
          price: 3.5,
          category: 'Chinese',
          image: 'images/veg-ckt.jpg',
          stallId: 4
        },
        {
          id: 9,
          name: 'Roasted Pork Belly Rice',
          price: 5.0,
          category: 'Chinese',
          image: 'images/roasted-pb-rice.jpg',
          stallId: 1
        },
        {
          id: 10,
          name: 'XL Chicken Cutlet Rice',
          price: 6.0,
          category: 'Chinese',
          image: 'images/xl-chickencutlet-rice.jpg',
          stallId: 1
        }
        // ... more items
      ],
    ...
    filteredItems() {
      ...
      if (this.activeCategory === 'Halal') {
        filtered = filtered.filter((item) =>
          this.stalls.find((stall) => stall.id === item.stallId && stall.halal)
        )
      } else if (this.activeCategory === 'Vegetarian') {
        filtered = filtered.filter((item) =>
          this.stalls.find((stall) => stall.id === item.stallId && stall.vegetarian)
        )
