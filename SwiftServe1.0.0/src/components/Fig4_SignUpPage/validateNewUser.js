...
export function validateNewUser(email, username, password, cPassword) {
    ...
    if (!usernameRegex.test(username)) {
      return { valid: false, message: 'Username must be 1-30 alphanumeric characters.' }
    }
    ...
    // Validate Password (8-20 alphanumeric characters, at least one uppercase and one lowercase)
